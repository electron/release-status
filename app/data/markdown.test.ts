...
import { renderGroupedReleaseNotes, renderMarkdownSafely } from './markdown.js';
...
describe('renderMarkdownSafely', () => {
  ...
  test('renders links correctly', () => {
    expect(renderMarkdownSafely('[foo](https://electronjs.org)')).toMatchInlineSnapshot(`
      "<p class="mb-2 text-base text-gray-800 dark:text-gray-200"><a class="text-[#2f3241] dark:text-[#9feaf9] hover:underline font-medium" rel="noopener noreferrer" href="https://electronjs.org" target="_blank">foo</a></p>
      "
    `);
  });
